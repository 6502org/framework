...
Our testing framework is built on [PHPUnit](http://phpunit.de/) and
...
[PHPUnit Manual](http://www.phpunit.de/manual/3.2/en/installation.html).
...
![](images/unit_test.gif)

### YAML Overview

[YAML](http://www.yaml.org/) (Rhymes with "camel") is our preferred method
