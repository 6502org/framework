...
We will talk more about the testing files in the [unit_testing](unit_testing.md) chapter.
...
> **Note:** The third argument to `find()` is an array of bind variables. It is
...
the Has-And-Belongs-To-Many association whenever possible. This declaration
is made in both models in the relationship.

![](images/has_many_through.gif)
...
> **Note:** This validation works by performing a SQL `SELECT` to check for the value
