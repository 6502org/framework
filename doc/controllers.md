...
[Horde_Routes documentation](http://dev.horde.org/routes/)
...
> **Note:** Use `./script/generate` with no arguments for help.  The example
...
> **Note:** PHP has a limitation where occasionally a name you would like for
